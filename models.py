...
class NeuralNet(nn.Module):
    ...
    Input                   :  1 x 128 x 128
    Convolution (1, 5, 5)   :  5 x 124 x 124
    MaxPool     (3, 3)      :  5 x  41 x  41
    ReLU                    :  5 x  41 x  41
    Convolution (5, 10, 5)  : 10 x  37 x  37
    MaxPool     (3, 3)      : 10 x  12 x  12
    ReLU                    : 10 x  12 x  12
    Convolution (10, 16, 5) : 16 x   8 x   8
    MaxPool     (2, 2)      : 16 x   4 x   4
    ReLU                    : 16 x   4 x   4
             reshape        :  1 x 256
